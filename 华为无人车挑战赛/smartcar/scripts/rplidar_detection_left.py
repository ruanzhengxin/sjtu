...
class rplidarDetector:
    def __init__(self):
        rospy.init_node('rplidar_detection_left', anonymous=True)
        rospy.Subscriber('/scan', LaserScan, self.callback)
        self.pub = rospy.Publisher('lidar_vel_left', Twist, queue_size=1)
    ...
    def road_detection(self, msg):
        ...
        '''
        offset = left_min1 - 0.52
        return offset, left_min1
